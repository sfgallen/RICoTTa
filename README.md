...
-	The uplift and exhumation history can reasonably be approximated as one-dimentional in the vertical direction (i.e., no significant horizontal tectonic velocities).
