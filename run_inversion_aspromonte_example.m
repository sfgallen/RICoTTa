...
param.gg=25;                  % intial geothermal gradient
...
% sample = [Time1, Time2, time3, U1, U2, U3, U4, K, n, m]
sample = [22.87,10.32,1.21,1.52,0.45,0.25, 0.87,2.77e-6,1.34,0.41];
...
% t1 t2 t3 u1 u2 u3 u4 k n m/n gg (m/n=0.4-0.7)
...
for it = 1:itmax+1
    ...
    if (it>1 || noforward~=1)
        ...
        for i=1:nsample
            misfits=forward_aspromonte(new_models(:,i),param);
...
forward_aspromonte_plot(param.sample,param);
