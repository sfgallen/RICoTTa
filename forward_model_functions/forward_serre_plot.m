function [misfit] = forward_serre_plot(sample,param)
...
plot(modelled_data.ahe(1:5),'ko','markerfacecolor',[0.1 0.1 0.9]);
title('AHe results')
xlabel('Sample')
ylabel('Age (Myr)')
...
plot(modelled_data.aft(6:8),'ko','markerfacecolor',[0.1 0.1 0.9]);
title('AFT results')
xlabel('Sample')
ylabel('Age (Myr)')
...
plot(modelled_data.aft_MTL(6:8),'ko','markerfacecolor',[0.1 0.1 0.9]);
title('AFT results')
xlabel('Sample')
