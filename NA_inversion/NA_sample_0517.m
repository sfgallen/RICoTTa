...
%----------------------------------------------------------------------------
function [new_models,xcur,restartNA,dlist]=NA_sample_0517(na_models,ntot,nsample,nd,nsleep,ncells,misfit,mfitord,range,check,xcur,calcmovement,nclean,inv_method)


global nxsave ndsave ndc nerr ncald nupd cells taxis tup tcd tdev tna tres
global taxis2 ic verbose debug sobol sob_seq
